...
The distribution of $log(\hat{\beta_{0}}\times\hat{\beta_{1}})$ is bell-shaped curve. The distribution peaks at approximately 2.01.
...
We can see from above the 95% CI-Band for $\hat{r}^{2}$ is (0.89,0.93) according to bootstrap. The 95% CI-Band for $log(\hat{\beta_{0}}\times\hat{\beta_{1}})$ is (1.96,2.06) according to bootstrap. 
